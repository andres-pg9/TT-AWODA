...
const Entrenamiento = () => {
    ...
    const diapositivas = [
                ...
                <div className="entrenamiento-contenido">
                    ...
                    <div className="grid-parametros">
                        <div className="parametro-card parametro-alfa">
                            ...
                            <p className="parametro-desc">¿Cuánto peso darle a las normas legales?</p>
                        </div>
                        <div className="parametro-card parametro-beta">
                            <p className="parametro-nombre">β (Beta)</p>
                            <p className="parametro-desc">¿Cuánto peso darle a las preferencias ciudadanas?</p>
                        </div>
                        <div className="parametro-card parametro-gamma">
                            <p className="parametro-nombre">γ (Gamma)</p>
                            <p className="parametro-desc">¿Cuánto peso darle al consumo histórico?</p>
                        </div>
                        <div className="parametro-card parametro-delta">
                            <p className="parametro-nombre">δ (Delta)</p>
                            <p className="parametro-desc">¿Cuánto peso darle a los reportes de fallas?</p>
                        </div>
                    </div>
                    <div className="desafio-box">
                        <p className="desafio-titulo">Desafío:</p>
                        <p className="desafio-texto">Encontrar el balance óptimo entre estos 4 factores que maximice la "calidad" de la distribución.</p>
                    </div>
                </div>
            )
        },
                ...
                <div className="entrenamiento-contenido">
                    <div className="pso-definicion">
                        ...
                        <p className="pso-descripcion">
                            Algoritmo de optimización inspirado en el comportamiento de bandadas de aves buscando comida.
                        </p>
                    </div>

                    <div className="analogia-box">
                        <h4 className="analogia-titulo">Analogía Simple:</h4>
                        <p className="analogia-intro">
                            Imagina que tienes 30 drones buscando el punto más alto de una montaña en la niebla:
                        </p>
                        <ul className="analogia-lista">
                            <li>Cada dron (partícula) explora una zona diferente</li>
                            <li>Todos comparten información sobre la mejor altura encontrada</li>
                    ...
                    <div className="resultado-box">
                        <p className="resultado-texto">
                            Después de muchas iteraciones, convergen hacia la cima de la montaña.
                        </p>
                    </div>
                </div>
            )
        ...
        {
            titulo: "El Espacio de Búsqueda",
            contenido: (
                <div className="entrenamiento-contenido">
                    <p className="intro-texto">
                        En lugar de buscar en una montaña física, PSO busca en un espacio matemático de <span className="highlight">4 dimensiones</span>:
                    </p>
                    ...
                    <div className="restricciones-grid">
                        <div className="restriccion-card">
                            <p className="restriccion-titulo">Restricción:</p>
            ...
            contenido: (
                <div className="entrenamiento-contenido">
                    <div className="componente-box componente-particulas">
                        <h4 className="componente-titulo">1️⃣ Partículas (Soluciones Candidatas)</h4>
                        <p className="componente-intro">Cada partícula representa una posible solución:</p>
                        <div className="codigo-box">
                            <p><span className="codigo-var">posición</span> = [0.30, 0.28, 0.25, 0.17]  <span className="codigo-comentario">// Sus pesos actuales</span></p>
                    ...
                    <div className="componente-box componente-global">
                        ...
                        <p className="componente-intro">La mejor solución encontrada por TODO el enjambre:</p>
                        <div className="codigo-box">
                    ...
                    <div className="componente-box componente-heuristica">
                        <h4 className="componente-titulo">3️⃣ La Heurística</h4>
                        <p className="componente-intro">Fórmula que calcula la prioridad de cada combinación:</p>
        ...
        {
            titulo: "Los Parámetros Explicados",
            contenido: (
                <div className="entrenamiento-contenido">
                    <div className="parametro-detalle parametro-detalle-azul">
                        ...
                        <p className="parametro-detalle-nota">
                            <span className="negrita">Balance típico:</span> 30-50 partículas para explorar simultáneamente
                        </p>
                    </div>

                    <div className="parametro-detalle parametro-detalle-purpura">
                        <h4 className="parametro-detalle-titulo">n_iterations = 150</h4>
                        <p className="parametro-detalle-desc">Número de ciclos de refinamiento</p>
                        <p className="parametro-detalle-nota">
                            Suficiente para que el algoritmo converja al óptimo
                        </p>
                    </div>

                    <div className="parametro-detalle parametro-detalle-verde">
                        <h4 className="parametro-detalle-titulo">w = 0.7 (Inercia)</h4>
                        <p className="parametro-detalle-desc">Porcentaje de dirección actual que mantiene cada partícula</p>
                        <div className="codigo-box">
                    ...
                    <div className="parametro-doble-grid">
                        ...
                        <div className="parametro-detalle parametro-detalle-rosa">
                            ...
                            <p className="parametro-detalle-nota-sm">Atracción hacia el mejor global</p>
                        </div>
                    </div>
                    ...
                    <div className="parametro-detalle parametro-detalle-gris">
                        ...
                        <p className="parametro-detalle-nota">
                            Con semilla: siempre da el mismo resultado (útil para pruebas)
                        </p>
                    </div>
                </div>
            )
            ...
            contenido: (
                <div className="entrenamiento-contenido">
                    <div className="resultado-final-box">
                        <h3 className="resultado-final-titulo">Pesos Óptimos Encontrados</h3>
